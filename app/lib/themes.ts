export interface Theme {
  id: string;
  name: string;
  group: "solid" | "gradient" | "illustration";
  canvasBg: string;
  cardBg: string;
  cardBgImage?: string;
  textColor: string;
...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    canvasBg: "#111",
    cardBg: "#000000",
    cardBgImage: "/samples/coin.png",
    textColor: "#ffffff",
    authorColor: "rgba(255,255,255,0.5)",
    accentColor: "#fff",
    iconColor: "rgba(255,255,255,0.5)",
    separatorColor: "rgba(255,255,255,0.2)",
    preview: "/samples/coin.png",
  },
  {
    id: "illust-dollar-girl",
    name: "金发女孩",
    group: "illustration",
    canvasBg: "#c0392b",
    cardBg: "#c0392b",
    cardBgImage: "/samples/dollar-girl.png",
    textColor: "#ffffff",
    authorColor: "rgba(255,255,255,0.6)",
    accentColor: "#fff",
    iconColor: "rgba(255,255,255,0.6)",
    separatorColor: "rgba(255,255,255,0.25)",
    preview: "/samples/dollar-girl.png",
  },
  {
    id: "illust-standing",
    name: "金币堆",
    ...
    canvasBg: "#1a7a7a",
    cardBg: "#1a7a7a",
    cardBgImage: "/samples/standing.png",
    textColor: "#ffffff",
    authorColor: "rgba(255,255,255,0.6)",
    accentColor: "#fff",
    iconColor: "rgba(255,255,255,0.6)",
    separatorColor: "rgba(255,255,255,0.25)",
    preview: "/samples/standing.png",
  },
  {
    id: "illust-frog",
    name: "青蛙",
    ...
    canvasBg: "#f5f0e8",
    cardBg: "#ffffff",
    cardBgImage: "/samples/frog.png",
    textColor: "#ffffff",
    authorColor: "rgba(255,255,255,0.6)",
    accentColor: "#fff",
    iconColor: "rgba(255,255,255,0.7)",
    separatorColor: "rgba(255,255,255,0.25)",
    preview: "/samples/frog.png",
  },
  {
    id: "illust-brush",
    name: "蓝色笔触",
    ...
    canvasBg: "#0066cc",
    cardBg: "#0066cc",
    cardBgImage: "/samples/brush.png",
    textColor: "#ffffff",
    authorColor: "rgba(255,255,255,0.6)",
    accentColor: "#fff",
    iconColor: "rgba(255,255,255,0.6)",
    separatorColor: "rgba(255,255,255,0.25)",
    preview: "/samples/brush.png",
  },
  {
    id: "illust-reading",
    name: "读书女孩",
    ...
    canvasBg: "#e64a19",
    cardBg: "#e64a19",
    cardBgImage: "/samples/reading.png",
    textColor: "#ffffff",
    authorColor: "rgba(255,255,255,0.6)",
    accentColor: "#fff",
    iconColor: "rgba(255,255,255,0.6)",
    separatorColor: "rgba(255,255,255,0.25)",
    preview: "/samples/reading.png",
  },
  {
    id: "illust-birds",
    name: "飞鸟",
    ...
    canvasBg: "#111",
    cardBg: "#000000",
    cardBgImage: "/samples/birds.png",
    textColor: "#ffffff",
    authorColor: "rgba(255,255,255,0.5)",
    accentColor: "#fff",
    iconColor: "rgba(255,255,255,0.5)",
    separatorColor: "rgba(255,255,255,0.2)",
    preview: "/samples/birds.png",
  },
  {
    id: "illust-sleeping",
    name: "午睡",
    ...
    canvasBg: "#f5f0e8",
    cardBg: "#faf3e8",
    cardBgImage: "/samples/sleeping.png",
    textColor: "#1a1a1a",
    authorColor: "rgba(0,0,0,0.4)",
    accentColor: "#333",
    iconColor: "rgba(0,0,0,0.3)",
    separatorColor: "rgba(0,0,0,0.15)",
    preview: "/samples/sleeping.png",
  },
  {
    id: "illust-landscape",
    name: "月下田野",
    ...
    canvasBg: "#8a8ac0",
    cardBg: "#8a8ac0",
    cardBgImage: "/samples/landscape.png",
    textColor: "#ffffff",
    authorColor: "rgba(255,255,255,0.6)",
    accentColor: "#fff",
    iconColor: "rgba(255,255,255,0.6)",
    separatorColor: "rgba(255,255,255,0.25)",
    preview: "/samples/landscape.png",
  },
  {
    id: "illust-knot",
    name: "绳结",
    ...
    canvasBg: "#c8c080",
    cardBg: "#c8c080",
    cardBgImage: "/samples/knot.png",
    textColor: "#1a1a1a",
    authorColor: "rgba(0,0,0,0.4)",
    accentColor: "#333",
    iconColor: "rgba(0,0,0,0.3)",
    separatorColor: "rgba(0,0,0,0.15)",
    preview: "/samples/knot.png",
  },
  {
    id: "illust-jungle",
    name: "丛林手机",
    ...
    canvasBg: "#1a3a2a",
    cardBg: "#1a3a2a",
    cardBgImage: "/samples/phone-jungle.png",
    textColor: "#ffffff",
    authorColor: "rgba(255,255,255,0.5)",
    accentColor: "#fff",
    iconColor: "rgba(255,255,255,0.5)",
    separatorColor: "rgba(255,255,255,0.2)",
    preview: "/samples/phone-jungle.png",
  },
];

      ...
      <div className="w-full max-w-xl relative z-10">
        ...
        <div className="relative">
          <textarea
            ...
            className="w-full h-56 sm:h-64 p-5 text-base text-gray-800 bg-white/85 backdrop-blur-sm border border-gray-200/60 rounded-2xl resize-none focus:outline-none focus:ring-2 focus:ring-gray-300/50 focus:border-gray-300 placeholder:text-gray-400 placeholder:leading-relaxed transition-all shadow-sm"
          />
          {text.length > 0 && (
        ...
        <div className="mt-4">
          <input
            ...
            placeholder="作者名（可选）"
            className="w-full px-5 py-3 text-sm text-gray-700 bg-white/85 backdrop-blur-sm border border-gray-200/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-300/50 focus:border-gray-300 placeholder:text-gray-400 transition-all shadow-sm"
          />
        </div>
